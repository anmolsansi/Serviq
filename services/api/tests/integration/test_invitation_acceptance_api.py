    ...
    async def scenario() -> None:
        ...
        try:
            ...
            async with httpx.AsyncClient(transport=transport, base_url="http://test") as client:
                # Happy path plus one-time replay protection.
                ...
                # Wrong email does not consume a still-valid invitation.
                ...
                # Caller assurance fails before invitation state is disclosed.
                ...
                # Each pending lifecycle scenario deliberately has a unique email so
                # the database's one-pending-invite-per-tenant/email invariant remains
                # active and the test reaches the intended acceptance condition.
                ...
                # The invitation row lock must serialize identical concurrent bearer
                # attempts, leaving exactly one membership/role transition.
                ...
                # Architecture explicitly permits invitation acceptance to activate a
                # suspended membership. Existing roles and origin metadata are kept.
            ...
            # Force a role-write failure through the exported tenancy service and prove
            # that no membership or accepted invitation state survives the rollback.
