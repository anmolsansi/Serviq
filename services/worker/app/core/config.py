"""Typed platform configuration boundary for the Serviq worker.

The worker mirrors the frozen environment-name contract locally because the
repository does not yet approve a shared Python package across services.
"""
